...
showShape (Clipped picture centre width height) =
  "Clipped[contents: "
    <> show picture
    <> ", clip center: "
    <> showPoint centre
...
getCenter (Line s e) = (s + e) * { x: 0.5, y: 0.5 } -- Magic SemiRing instance
...
shapeBounds (Clipped picture centre width height) =
  intersect (bounds picture)
    $ shapeBounds
